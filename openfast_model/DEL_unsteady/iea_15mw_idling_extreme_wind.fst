...
5e-5                   ConvTol     - Convergence iteration error tolerance for tight coupling generalized alpha integrator (-)
50                    NIter_UJac  - Update Jacobians every N convergence iterations for tight coupling generalized alpha integrator (-)
...
0                      CompSeaSt   - Compute seast, dummy
...
30.0                   WtrDpth     - Water depth (m)
0.0                    MSL2SWL     - Offset between still-water level and mean sea level (m) [positive upward]
---------------------- INPUT FILES ---------------------------------------------
"iea_15mw_idling_extreme_wind_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"iea_15mw_idling_extreme_wind_BeamDyn.dat" BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"iea_15mw_idling_extreme_wind_BeamDyn.dat" BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"iea_15mw_idling_extreme_wind_BeamDyn.dat" BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"iea_15mw_idling_extreme_wind_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"iea_15mw_idling_extreme_wind_AeroDyn15.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"iea_15mw_idling_extreme_wind_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"unused"               SeaState    - SeaState dummy
