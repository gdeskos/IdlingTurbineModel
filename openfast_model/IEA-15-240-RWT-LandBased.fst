...
---------------------- INPUT FILES ---------------------------------------------
"IEA-15-240-RWT-LandBased_ElastoDyn.dat"  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-15-240-RWT-LandBased_AeroDyn15_cfd.dat"  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"IEA-15-240-RWT-LandBased_ServoDyn.dat"   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
